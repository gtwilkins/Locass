...
// Node Reliability
public:
    bool isMisassembled( bool drxn );
    bool isMisassembled( Querier &bwt, NodeList &nodes, int32_t* validLimits, bool drxn );
private:
    bool isMisassembled( int &iBest, int &jBest, bool drxn );
...
private:
    bool validated_, reliable_, unreliable_;
